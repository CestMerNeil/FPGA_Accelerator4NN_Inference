...
struct config2 : nnet::conv2d_config {
    ...
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 85;
...
struct config6 : nnet::conv2d_config {
    ...
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 906;
    static const unsigned multiplier_limit =
        DIV_ROUNDUP(kernel_size * n_chan * n_filt, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    static const unsigned strategy = nnet::latency;
...
struct config11 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::latency;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 637;
    static const unsigned n_nonzeros = 1283;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef model_default_t accum_t;
...
struct config13 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 265;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef model_default_t accum_t;

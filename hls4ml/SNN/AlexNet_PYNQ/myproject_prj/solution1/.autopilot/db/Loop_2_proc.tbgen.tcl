...
set C_modelArgList {
	...
	{ tmp_data_V_1853 int 16 regular {pointer 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "out_data", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "tmp_data_V_1853", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tmp_data_V_1853 sc_in sc_lv 16 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_data_V_1853", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "tmp_data_V_1853", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "tmp_data_V_1853", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_axi_mux_104_16_1_1_U48", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_axi_lshr_32ns_32ns_32_2_1_U49", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myproject_axi_shl_64ns_32ns_64_2_1_U50", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	tmp_data_V_1853 { ap_none {  { tmp_data_V_1853 in_data 0 16 } } }

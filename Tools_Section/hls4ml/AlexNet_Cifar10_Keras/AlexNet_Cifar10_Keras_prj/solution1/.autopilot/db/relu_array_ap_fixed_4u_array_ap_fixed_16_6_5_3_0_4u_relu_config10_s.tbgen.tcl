...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer7_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer7_out { ap_fifo {  { layer7_out_dout fifo_port_we 0 64 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer7_out_fifo_cap fifo_update 0 9 }  { layer7_out_empty_n fifo_status 0 1 }  { layer7_out_read fifo_data 1 1 } } }
	layer10_out { ap_fifo {  { layer10_out_din fifo_port_we 1 64 }  { layer10_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer10_out_fifo_cap fifo_update 0 9 }  { layer10_out_full_n fifo_status 0 1 }  { layer10_out_write fifo_data 1 1 } } }
}
set moduleName relu_array_ap_fixed_4u_array_ap_fixed_16_6_5_3_0_4u_relu_config10_s
set isTopModule 0
set isCombinational 0

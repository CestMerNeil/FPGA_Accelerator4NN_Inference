set moduleName zeropad2d_cl_array_array_ap_fixed_16u_config41_Pipeline_PadTopWidth
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {zeropad2d_cl<array,array<ap_fixed,16u>,config41>_Pipeline_PadTopWidth}

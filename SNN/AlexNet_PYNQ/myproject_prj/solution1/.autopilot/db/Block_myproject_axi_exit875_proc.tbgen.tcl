set moduleName Block_myproject_axi_exit875_proc
set isTopModule 0
...
set C_modelName {Block_myproject_axi_.exit875_proc}
...
set C_modelArgList {
	...
	{ tmp_data_V_1853 int 16 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "out_local_V_data_0_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "tmp_data_V_1853", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ tmp_data_V_1853 sc_out sc_lv 16 signal 11 } 
	{ tmp_data_V_1853_ap_vld sc_out sc_logic 1 outvld 11 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_data_V_1853", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "tmp_data_V_1853", "role": "default" }} , 
 	{ "name": "tmp_data_V_1853_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "tmp_data_V_1853", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "tmp_data_V_1853", "Type" : "Vld", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"},
...
set Spec2ImplPortList { 
	...
	tmp_data_V_1853 { ap_vld {  { tmp_data_V_1853 out_data 1 16 }  { tmp_data_V_1853_ap_vld out_vld 1 1 } } }
